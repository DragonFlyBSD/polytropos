...
def test_chown_is_skipped_when_the_logs_root_is_absent(tmp_path) -> None:
    """Nothing to hand over yet; the services create it on first run."""
...
def test_chown_is_planned_when_the_tree_exists(tmp_path) -> None:
    ...
    predates the account — /build/synth/logs/evidence on x6 is root:wheel."""
    logs = tmp_path / "logs"
