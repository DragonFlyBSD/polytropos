...
def build_parser() -> argparse.ArgumentParser:
    ...
    # NOTE: `health` used to live here. The probe's code is in the generator
    # (dportsv3.agent.health, which needs dportsv3.agent.worker), so hosting
    # its CLI here meant this package importing the generator back — a cycle,
    # bridged by a sys.path hack. It is now `dportsv3 env-health NAME`.
